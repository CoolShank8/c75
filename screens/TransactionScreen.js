...
import {ToastAndroid, Text, View, TouchableOpacity, TextInput, Image, StyleSheet, KeyboardAvoidingView, Alert} from 'react-native';
...
export default class TransactionScreen extends React.Component {
  ...
  render(){
    ...
    if(buttonState !== "normal" && hasCameraPermissions){ // this doesn't run because HasCamerapermissions is false 
      return(
        <BarCodeScanner
    ...
    else if (buttonState === "normal"){ // button state is bookid so this doesn't run
    
      return(
              

          <KeyboardAvoidingView style = {{backgroundColor: 'red'}} behavior = 'padding' enabled> 
